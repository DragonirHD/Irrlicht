...
@Component({
  ...
  templateUrl: './cursor-light-overlay.html',
  styleUrl: './cursor-light-overlay.scss'
})
export class CursorLightOverlay implements AfterViewInit {
  ...
  //TODO create alternative animation to cursorLight for mobile users
}
